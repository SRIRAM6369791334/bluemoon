(function($) {
  ...
  // Product Slider Col4 Js
    ...
    // brand
 var productSliderCol4 = new Swiper('.product-slider-col4-container2', {
  slidesPerView: 6,
  slidesPerGroup: 1,
  ...
  mousewheel: {
    forceToAxis: true, // Allows horizontal scrolling with mousewheel
    invert: false,     // Set to true if direction needs to be inverted
