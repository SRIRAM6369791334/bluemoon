...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.global-settings.update') }}" method="POST" enctype="multipart/form-data" id="globalSettingsForm">
        @csrf
        @method('PUT')
                ...
                <div class="card settings-card animate-fade-in">
                    <div class="card-body">
                        <div class="nav flex-column nav-pills nav-settings" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <button class="nav-link active text-start" id="v-pills-brand-tab" data-bs-toggle="pill" data-bs-target="#v-pills-brand" type="button" role="tab">
                                <i class="fas fa-store"></i> Brand & Logos
                            </button>
                            <button class="nav-link text-start" id="v-pills-social-tab" data-bs-toggle="pill" data-bs-target="#v-pills-social" type="button" role="tab">
                                <i class="fas fa-share-alt"></i> Contact & Social
                            </button>
                            <button class="nav-link text-start" id="v-pills-advanced-tab" data-bs-toggle="pill" data-bs-target="#v-pills-advanced" type="button" role="tab">
                                <i class="fas fa-code"></i> Advanced & SEO
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-9">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="v-pills-brand" role="tabpanel">
                        <div class="card settings-card animate-fade-in">
                            <div class="card-body">
                                ...
                                <div class="row">
                                   <div class="col-md-6 mb-custom">
                                        <label class="form-label">Main Logo <small class="text-danger">(140 x 69 px)</small></label>
                                        <div class="image-preview-card">
                                            <img id="logoPreview" src="{{ ($setting && $setting->logo) ? asset($setting->logo) : 'https://placehold.co/200x60?text=LOGO' }}" alt="Logo">
                                            <div class="mt-2 text-muted small"><i class="fas fa-upload"></i> Change Logo</div>
                                        </div>
                                        <input type="file" name="logo" class="hide-input premium-image-input @error('logo') is-invalid @enderror" data-preview="logoPreview" accept="image/*">
                                        @error('logo')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-custom">
                                        <label class="form-label">Favicon <small class="text-danger">(40 x 40 px)</small></label>
                                        <div class="image-preview-card">
                                            <img id="faviconPreview" src="{{ ($setting && $setting->favicon) ? asset($setting->favicon) : 'https://placehold.co/32x32?text=F' }}" alt="Favicon" style="width: 32px; height: 32px; object-fit: contain;">
                                            <div class="mt-2 text-muted small"><i class="fas fa-upload"></i> Change Icon</div>
                                        </div>
                                        <input type="file" name="favicon" class="hide-input premium-image-input" data-preview="faviconPreview" accept="image/x-icon,image/png">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-custom">
                                        ...
                                        <input type="text" name="phone_number" class="form-control" value="{{ $setting->phone_number ?? '' }}">
                                    </div>
                                    <div class="col-md-6 mb-custom">
                                    ...
                                    <div class="col-md-12 mb-custom">
                                        ...
                                        <textarea name="footer_content" class="form-control summernote" rows="3">{{ $setting->footer_content ?? '' }}</textarea>
                                    </div>
                                </div>

                                <h5 class="settings-section-title mt-4"><i class="fas fa-hashtag"></i> Social Presence</h5>
                                <div class="row">
                    ...
                    <div class="tab-pane fade" id="v-pills-advanced" role="tabpanel">
                        <div class="card settings-card">
                            <div class="card-body">
                                <h5 class="settings-section-title"><i class="fas fa-bullhorn"></i> Top Offer Bar</h5>
                                <div class="mb-custom">
                                    <label class="form-label">Offer Text (Supports HTML)</label>
                                    <textarea name="top_offer_text" class="form-control summernote" rows="3">{{ $setting->top_offer_text ?? '' }}</textarea>
                                </div>
