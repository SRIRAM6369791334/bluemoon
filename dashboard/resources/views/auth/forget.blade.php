...
<head>
    ...
    <meta charset="utf-8" />
    <title>{{ $globalSetting->company_name ?? 'Bluvel Crackers' }} | Admin Dashboard</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="{{ $globalSetting->company_name ?? 'Bluvel Crackers' }} Admin Dashboard" name="description" />
...
<body data-topbar="dark">
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-xxl-3 col-lg-4 col-md-5">
                    <div class="auth-full-page-content d-flex p-sm-5 p-4" style="background-color: #ffed00">
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                <div class="text-center">
                                    <a href="#" class="d-block auth-logo">
                                        ...
                                        <span
                                            class="logo-txt">{{ $globalSetting->company_name ?? 'Bluvel Crackers' }}</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted mt-2">Sign in to continue to
                                            {{ $globalSetting->company_name ?? 'Bluvel Crackers' }}</p>
                                    </div>
                                    <form class="mt-4 pt-2" action="" id="forget_form">
                                        ...
                                        <div
                                            class="form-floating form-floating-custom mb-4 auth-pass-inputgroup position-relative">
                                            <input type="password" class="form-control pe-5" id="newpassword_input"
                                                placeholder="Enter Password">

                                            <button type="button"
                                                class="btn btn-link position-absolute h-100 end-0 top-0"
                                                id="password-addon" tabindex="-1">
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Go Back to <a href="/"
                                ...
                                {{-- <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        ...
                                        </script> Ramji Traders . Crafted with <i
    ...
    <script>
        document.getElementById('password-addon').addEventListener('click', function () {
            const passwordInput = document.getElementById('newpassword_input');
