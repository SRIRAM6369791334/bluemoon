<header id="page-topbar">
    <div class="navbar-header" style="background-color: #fff">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box" style="background-color: #fff">
                <a href="{{ url('/') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ $globalSetting && $globalSetting->logo ? asset($globalSetting->logo) : asset('assets/images/logo/ram_logo1.png') }}" alt="{{ $globalSetting->company_name ?? 'Logo' }}" style="width: 140px">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ $globalSetting && $globalSetting->logo ? asset($globalSetting->logo) : asset('assets/images/logo/ram_logo1.png') }}" alt="{{ $globalSetting->company_name ?? 'Logo' }}" style="width: 140px"> <span
                            class="logo-txt"></span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <!--        aria-expanded="false">-->
            <!--        <i data-feather="bell" class="icon-lg" style="color: white-->
            <!--        "></i>-->
